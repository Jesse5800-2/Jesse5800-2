...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/wp1.jpg",
			"assets/images/DesktopWallpaper/wp2.jpg",
			"assets/images/DesktopWallpaper/wp3.jpg",
			"assets/images/DesktopWallpaper/wp4.jpg",
			"assets/images/DesktopWallpaper/wp5.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/001.jpg",
			"assets/images/MobileWallpaper/002.jpg",
			"assets/images/MobileWallpaper/003.jpg",
