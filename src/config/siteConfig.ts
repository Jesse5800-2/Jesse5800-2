...
export const siteConfig: SiteConfig = {
	// 站点标题
	title: "早川智将的垃圾堆 - [Reboot II]",

	// 站点副标题
	subtitle: "二次翻修的精装垃圾堆",

	// 站点 URL
	site_url: "https://chicyo-jesse.netlify.app",

	// 站点描述
	description:
		"你说得对，但是Fuwari是由saicaca开发制作的基于Astro的静态博客模板，而Firefly是CuteLeaf基于二者二次开发的超级增强版本...",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/logo/jesse_light.png",
			valueDark: "assets/images/logo/gudako_dark.png",
			alt: "🍀",
		},
		// 导航栏标题
		title: "Chicyo",
