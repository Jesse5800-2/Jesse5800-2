...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: "もう少しだけ,by pixiv@mocha", // Credit text to be displayed
			url: "https://www.pixiv.net/artworks/91451279", // (Optional) URL link to the original artwork or artist's page
		},
	},
	toc: {
		...
		// Leave this array empty to use the default favicon
		 {
		  ...
		  {
		   src: 'favicon/icon_dark.png',    // Path of the favicon, relative to the /public directory
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/Jesse5800-2/", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://twitter.com/@NobitaZhen22128",
		},
		//{
		//	name: "Pixiv",
